<%@ Page Title="" Language="C#" MasterPageFile="~/A2/Admin.master" AutoEventWireup="true" CodeFile="CandidateProfile_.aspx.cs" Inherits="A2_Candidate_CandidateProfile_" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="Server">
    ...
    <div id="frame-sets" style="display: none;">
        <div>
            <img id="imgBigImage" runat="server" alt="" width="500" height="500" /></div>
    </div>
