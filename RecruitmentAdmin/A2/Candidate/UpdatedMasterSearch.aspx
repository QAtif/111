<%@ page title="" language="C#" masterpagefile="~/A2/Admin.master" autoeventwireup="true" CodeFile="UpdatedMasterSearch.aspx.cs" Inherits="A2_Candidate_UpdatedMasterSearch" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
    ...
    <ul class="TopLeftMenu">
      <li><a href="javascript:;" id="af" runat="server" data-rel="fresh-search-div" title="" class="active" onclick="$('#hdnSelectedTab').val('1')">Fresh</a></li>
      <li class="borderNone">|</li>
      <li><a href="javascript:;" id="ae" runat="server" data-rel="experienced-search-div" title="" onclick="$('#hdnSelectedTab').val('2')">Experienced</a></li>
    ...
    <div id="sortable" class="main-wrapper" style="padding: 2px 9px 0 9px !important;">
      ...
      <div style="background-color: White; padding: 5px 0px 0px 0px;" id='UlMain'>
 ...
 function ClickSerachType(obj) {
           // alert('a');
            ...
            if (obj == '1') {
                $('#ctl00_BodyContent_af').addClass('active');
                console.log('f');
                $('#btnSearchF').show();
                $('#btnSearchE').hide();
                ...
                if (obj == '2') {
                    $('#ctl00_BodyContent_ae').addClass('active');
                    console.log('E');
                    $('#btnSearchF').hide();
                    $('#btnSearchE').show();
