...
public partial class A2_Candidate_UpdatedMasterSearch_ : CustomBasePage
{
    ...
    public void GetExperienceCandidate(int page)
    {
        ...
        if (!string.IsNullOrEmpty(txtCompany.Text))
            selectCommand.Parameters.Add("@CompanyCodes", txtCompany.Text);
        if (!string.IsNullOrEmpty(txtDesignation.Text))
            selectCommand.Parameters.Add("@Designation", txtDesignation.Text);
        ...
        if (!string.IsNullOrEmpty(txtSKillSetE.Text))
            selectCommand.Parameters.Add("@KeywordCodeCSV", txtSKillSetE.Text);
