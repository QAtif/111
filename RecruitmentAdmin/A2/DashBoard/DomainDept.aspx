<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/A2/Admin.master"
    CodeFile="DomainDept.aspx.cs" Inherits="A2_DashBoard_DomainDept" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="Server">
    ...
    <div class="page">
        ...
        <span class="msearch showsrchbox">Domain Owner Other Department</span>
    </section>
        <!-- TOPMENU END HERE -->
        ...
        <div class="clearfix">
            <ul class="pendingColumn">
                <li class="radishColor grid_240">
                    <div class="clearfix">
                        <i class="note-icon"></i>
                        <span>Interviews Pending <br> My Approval</span>
                    </div>
                    <ul class="clearfix">
                ...
                <li class="orangeColor grid_240">
                    <div class="clearfix">
                        <i class="opd-icon"></i>
                        <span>Requisition to be <br> approved By OPD</span>
                    </div>
                    <ul class="clearfix">
