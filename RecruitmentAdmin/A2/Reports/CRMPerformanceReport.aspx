<%@ Page Title="" Language="C#" MasterPageFile="~/A2/Admin.master" AutoEventWireup="true" CodeFile="CRMPerformanceReport.aspx.cs" Inherits="A2_Reports_CRMPerformanceReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="Server">
    ...
    <div class="ShowAllDataGrid">
        <section class="wrapit topmenu offeraproval" style="max-width: 989px !important; min-width: 1018px !important;"> <span class="msearch"><i class="deptstruct-icon"></i>CRM Performance Report</span>
              ...
              <div class="accordian-btn">
                ...
                <%--  <input type="checkbox" name="checkIt">--%>
                  ...
                  <ul class="subcnt" style="width: 247px !important;">
                  	<li style="width: 239px !important;"><strong><%# Eval("TotalScheduleCount")%></strong> <strong class="status">Total Scheduled Candidate</strong></li>
