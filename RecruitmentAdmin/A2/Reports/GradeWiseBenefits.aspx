<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/A2/Admin.master"
    CodeFile="GradeWiseBenefits.aspx.cs" Inherits="A2_Reports_GradeWiseBenefits" %>
            ...
            <asp:GridView ID="gvDetails" DataKeyNames="OG_OfferletterDataLattest" runat="server"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Action" HeaderStyle-HorizontalAlign="Left">
                        ...
                        <ItemTemplate>
                        <div id="divAction131" runat="server" visible="false" clientidmode="Static">
                    ...
                    <div class="action-pad">
                        <div class="save-btn">                            
                                                ...
                                                <asp:LinkButton  ID="lnkapproveAll" runat="server" ToolTip="Save All" 
                                                    ...
                                                    OnClientClick="return valthisform();" onclick="lnkapproveAll_Click" 
                                                    ></asp:LinkButton>
