...
public partial class A2_Reports_GradeWiseBenefits : CustomBasePage, IRequiresSessionState
{
    ...
    {
        SqlCommand selectCommand = new SqlCommand("dbo.XRec_Select_GetAllOfferLetterData", connection);
    ...
    protected void gvDetails_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        try
        {
            ...
            connection.Open();
            SqlCommand sqlCommand = new SqlCommand("dbo.Update_OfferLetter_Data", connection);
    ...
    public DataTable GetAxactBenefit()
    {
        ...
        try
        {
            ...
            selectCommand.Parameters.Add("@Comapany_Code", SqlDbType.VarChar).Value = 1;
            selectCommand.CommandType = CommandType.StoredProcedure;
