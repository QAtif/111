<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/A2/Admin.master"
    CodeFile="MapInstitute.aspx.cs" Inherits="A2_Reports_MapInstitute" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="headerContent" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function valthisform() {
            ...
            if (okay) {
                if (dpt.selectedIndex != '-1')
                    return confirm('Are you sure you want to Map this Institute');
                else {
        ...
        function valthisformInstitute() {
            //debugger;
            var frm = document.getElementById('ctl00_BodyContent_txtInstitute');
            if (frm.value != '')
                return true;
            else {
    ...
    <section class="pagewrap">
    	<article>
                    ...
                    <asp:Repeater ID="rptInstitute" runat="server" OnItemDataBound="rptInstitute_ItemDataBound">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td align="left">
                                    <%# Eval("Institute")%>
                                    <asp:HiddenField runat="server" ID="hdfInstituteCode" Value='<%# Eval("Institute_Code")%>' />
                                </td>
            ...
            <div class="rightside">
            	...
            	<asp:ListBox ID="client2View" runat="server" SelectionMode="Single" CssClass="multiselectbox" DataTextField="Institute" DataValueField="Institute_Code"></asp:ListBox>
            ...
            <asp:Button ID="ImageButton1" Text="Map Institute" OnClick="BtnSearchFresh_Click" ImageUrl="" ToolTip="Map Institute"
                OnClientClick="return valthisform();" CssClass="input-submit" runat="server" />
            
            <input type="button" value="Add New Institute" class="input-submit" onclick="ShowDiv();" />
            <br clear="all">

            	<div id="dvIns" class="hiddentbl">
                    <div class="row"><label>Institute Name :</label>
                    <asp:TextBox runat="server" ID="txtInstitute"></asp:TextBox></div>
                    
                   <div class="row"> <label>Institute Logo :</label>
