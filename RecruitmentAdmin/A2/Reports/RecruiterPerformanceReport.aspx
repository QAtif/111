<%@ Page Title="" Language="C#" MasterPageFile="~/A2/Admin.master" AutoEventWireup="true" CodeFile="RecruiterPerformanceReport.aspx.cs" Inherits="A2_Reports_RecruiterPerformanceReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="Server">
    <div style="position: absolute; right: 517px; top: 119px;">
        ...
        <asp:LinkButton ID="btnSearch" OnClientClick="javascript:$('#imgLoadingF').show();"
            OnClick="btnSearch_Onclick" runat="server" Style="top: 5px; position: relative; left: 10px;">
                    <img alt="" src="../assets/images/search-b.png" height="20" width="20" /></asp:LinkButton>
        <img id="imgLoadingF" runat="server" src="~/assets/images/loading.gif" alt="" style="display: none; position: absolute; right: -85px; bottom: -10px;"
            clientidmode="Static" />
    </div>
    <div class="ShowAllDataGrid">
        <section class="wrapit topmenu offeraproval" style="max-width: 989px !important; min-width: 1018px !important;"> <span class="msearch"><i class="deptstruct-icon"></i>Productivity Head Count Report</span>
            ...
            <li>
              <div class="accordian-btn">
                ...
                <%--  <input type="checkbox" name="checkIt">--%>
                  ...
                  <div><%# Eval("UserName") %> <i></i>
                   
                  <asp:HiddenField ID="hdnUserId" runat="server" Value='<%# Eval("UserID") %>' />

                  <ul class="subcnt" style="width: 247px !important;">
                  	<li style="width: 239px !important;"><strong><%# Eval("TotalScheduleCount")%></strong> <strong class="status">Total Activities</strong></li>
                  <%--  <li><strong><%# Eval("Interview") %></strong> <strong class="status">Interview</strong></li>
                   ...
                   <asp:LinkButton ID="lnkExport" CommandArgument='<%# Eval("UserID") %>' CommandName="Export" runat="server" Text="Export to excel"
                           ...
                           <asp:Repeater ID="RptDeptHired" runat="server"><ItemTemplate>
                                <li style="width:181px !important;">                                	                              
                                  <div class="carousel-box" style="height:45px !important; width:169px !important; margin-top: 20px;">
                                  	...
                                  	<ul class="subcnt">                                  
                                      <li class="odd" style="width:189px;"><strong><%# Eval("StatusCount") %></strong> <strong class="status"><%# Eval("status_name") %></strong></li>                                     
                                    </ul> 
                             ...
                             <asp:Label id="lblMsg" runat="server" Visible="false" ForeColor="Red" style="position: absolute;left: 45%;top: 40%;right: 0px;">No records found.</asp:Label>
                            <!-- Prev/next controls --> 
