<%@ Page Title="" Language="C#" MasterPageFile="~/Popup.master" AutoEventWireup="true"
    CodeFile="AddEditQuestion.aspx.cs" Inherits="AddEditQuestion" %>
    ...
    <script type="text/javascript">
        ...
        function ShowOption(ddl1) {
            ...
            if (ddl[ddl.selectedIndex].value == "2") {
                document.getElementById('ctl00_BodyContent_trBlank').style.display = "";
                document.getElementById('ctl00_BodyContent_trOption').style.display = "none";
                document.getElementById('ctl00_BodyContent_trIsCorrect').style.display = "none";
                document.getElementById('ctl00_BodyContent_trAdd').style.display = "none";
                document.getElementById('ctl00_BodyContent_trBrowseFile').style.display = "none";

            }
            if (ddl[ddl.selectedIndex].value == "4") {
                document.getElementById('ctl00_BodyContent_trBlank').style.display = "none";
                document.getElementById('ctl00_BodyContent_trOption').style.display = "none";
                document.getElementById('ctl00_BodyContent_trIsCorrect').style.display = "none";
                document.getElementById('ctl00_BodyContent_trAdd').style.display = "none";
                document.getElementById('ctl00_BodyContent_trBrowseFile').style.display = "";

            }
            if (ddl[ddl.selectedIndex].value == "1" || ddl[ddl.selectedIndex].value == "3") {
                document.getElementById('ctl00_BodyContent_trBlank').style.display = "none";
                document.getElementById('ctl00_BodyContent_trOption').style.display = "";
                document.getElementById('ctl00_BodyContent_trIsCorrect').style.display = "";
                document.getElementById('ctl00_BodyContent_trAdd').style.display = "";
                document.getElementById('ctl00_BodyContent_trBrowseFile').style.display = "none";
            }
        }
