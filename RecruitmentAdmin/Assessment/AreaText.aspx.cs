...
public partial class Venue : System.Web.UI.Page//XRecBase
{
    #region Variables
    ...
    protected void rptStatus_ItemDataBound(object source, RepeaterItemEventArgs e)
    {
        ...
        try
        {
            ...
            control1.Attributes.Add("onclick", "javascript:return confirm('Are you sure you want to delete this Status?')");
            HiddenField control2 = (HiddenField)e.Item.FindControl("hfStatusCode");
            ((HtmlControl)e.Item.FindControl("btnEdit")).Attributes.Add("href", "AddEditStatusText.aspx?sid=" + control2.Value);
        }
        catch (Exception ex)
        {
            throw;
    ...
    protected void rptStatus_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        {
            connection.Open();
            SqlCommand selectCommand = new SqlCommand("XRec_Delete_Status", connection);
            selectCommand.CommandType = CommandType.StoredProcedure;
            selectCommand.Parameters.AddWithValue("@StatusCode", e.CommandArgument);
            selectCommand.Parameters.AddWithValue("@UpdatedByUser", "0");
