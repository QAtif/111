<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="SlotGenerationPortalSyn.aspx.cs" Inherits="SlotGenerationPortalSyn" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function ShowRepeater(obj, obj1) {
        ...
        function CheckAllCheckBoxes(obj) {
            ...
            for (var i = 0; i < chk.length; i++) {
                ...
                if (chk[i].id.indexOf('chkProtalSlots') >= 0) {
        ...
        function ValidateFromDate(oSrc, args) {
            var txtFrom = document.getElementById('postedFromDate').value;
            var txtTo = document.getElementById('postedToDate').value;
    ...
    <div id="container" class="contentarea">
        <div align="left">
            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                ...
                <tr class="bold center" style="display: none">
                    <td style="text-align: left">
                        From Time
                    </td>
                    <td style="text-align: left">
                        <asp:DropDownList ID="ddlFromTime" Enabled="false" runat="server" Style="width: auto"
                ...
                <tr class="simple">
                    ...
                    <td>
                        <input runat="server" width="50px" type="text" id="postedToDate" style="width: 120px"
                            clientidmode="Static" />
                        <asp:CustomValidator ID="CustomValidator1" runat="server" Display="Dynamic" ErrorMessage="To date must be less then From Date"
                            Text="<img src='/assets/images/Exclamation.gif' title='To date must be less then From Date!' />"
                            ControlToValidate="postedToDate" ClientValidationFunction="ValidateFromDate"></asp:CustomValidator>
            ...
            <br />
            <br />
            <table border="0" cellpadding="10" cellspacing="0" class="none">
                <tr class="grey">
                    <td colspan="4" align="center">
                        ...
                        <asp:LinkButton runat="server" ID="LinkButton1" CssClass="btn-ora nl" OnClick="lnkPortalSearch_Click">
                        <img src="/assets/images/icons/search.png" width="12" height="13" alt="" align="absmiddle" />&nbsp;Portal Search
                        </asp:LinkButton>
            ...
            <br />
            <table cellpadding="0" cellspacing="0" border="0" runat="server" id="tblMsg" class="none">
                <tr align="center" class="grey">
                    <td align="center">
                        <asp:Label runat="server" Font-Bold="true" ID="lblMsg" Visible="false"></asp:Label><br />
                        <span style="color: Red">
                            <asp:Literal runat="server" ID="ltrMsg" Visible="false"></asp:Literal></span>
                    </td>
                </tr>
            </table>
            <table border="0" cellpadding="0" cellspacing="0" id="tblPortalRecord" runat="server"
                width="100%">
                <tr>
                    <td style="margin: 0px; padding: 0px">
                        <asp:Repeater ID="rptPortalRecord" runat="server">
                            <HeaderTemplate>
                                <tr>
                            ...
                            <ItemTemplate>
                                <tr class="simple">
                                    <td align="center">
                                        <asp:CheckBox ID="chkProtalSlots" runat="server" />
                                        <asp:HiddenField ID="hdnSlotDetaiId" runat="server" Value='<%# Eval("Facility_Slot_Detail_ID")%>' />
                                    </td>
                                    <td align="center">
                                        <asp:Label ID="Facility_Slot_Date" runat="server" Text='<%# Convert.ToDateTime(Eval("Facility_Slot_Date")).ToString("dd, MMM yyy")%>'>
                                        </asp:Label>
                                    </td>
                                    <td align="center">
                                        <asp:Label ID="Start_Time" runat="server" Text='<%# Eval("Start_Time")%>'>
                                        </asp:Label>:00
                                    </td>
                                    <td align="center">
                                        <asp:Label ID="End_Time" runat="server" Text='<%# Eval("End_Time")%>'>
                                        </asp:Label>:00
                                    </td>
                                </tr>
                            </ItemTemplate>
                ...
                <tr id="trgenerate" runat="server" visible="false">
                    <td colspan="4" align="right" style="height: 30px">
                        <asp:LinkButton runat="server" ID="LinkButton2" CssClass="btn-ora nl" OnClick="btn_GeneratePortal"
                            OnClientClick="javascript:return Validate();">Generate                       
                        </asp:LinkButton><br />
                    </td>
                </tr>
            </table>
            <table border="0" cellpadding="10" cellspacing="0" id="tblRecruitmentRecord" runat="server">
                <tr>
                    <td style="margin: 0px; padding: 0px">
            ...
            <br />
            <table border="0" cellpadding="5" cellspacing="0" class="none" id="tblpagging" runat="server">
