<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CandidateDiploma.aspx.cs"
    Inherits="CandidateDiploma" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ValidateDiploma(source, args) {

            if (document.getElementById('hfDiploma').value.toString() != "")
                args.IsValid = true;
            else0
                args.IsValid = false;
        }
        ...
        function InstituteItemSelected(sender, e) {
            document.getElementById("hfInstitute").value = e.get_value();
            //console.log(e);
            //console.log(sender);
        }
        function DiplomaItemSelected(sender, e) {
            document.getElementById("hfDiploma").value = e.get_value();
        }
        function FieldItemSelected(sender, e) {
            document.getElementById("hfField").value = e.get_value();
        }
...
<body>
    <div>
        ...
        <asp:ScriptManager ID="ScriptManager1" runat="server">
            ...
            <h3 class="popup-hd-top" style="width: 91.6%;">
                Add/Edit Diploma Documents
            </h3>          
                                        ...
                                        <asp:Repeater ID="rptExperience" runat="server" OnItemCommand="rptExperience_OnItemCommand">
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td bgcolor="#ffffff">
                                                        <%# DataBinder.Eval(Container.DataItem, "Diploma")%>
                                                    </td>
                                                    <td bgcolor="#ffffff">
                                                    ...
                                                    <td bgcolor="#ffffff" align="center">
                                                        ...
                                                        <asp:ImageButton ID="imgDel" runat="server" ImageUrl="/assets/images/0.gif" OnClientClick="javascript:return confirm('Are you sure you want to delete the selected Diploma?');"
                                ...
                                <tr>
                                    <td colspan="3" class="error">
                                        <asp:ValidationSummary ID="vsValidators" HeaderText="<div class='validationheader'>&nbsp;Important:</div>"
                                            ...
                                            runat="server" ValidationGroup="Check" />
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="3">
                                                ...
                                                <td align="left" valign="middle">
                                                    ...
                                                    <div class="ui-widget">
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtInstitute"
                                                            ErrorMessage="Please Select Institute" Font-Bold="True" ForeColor="Red" Text="<img src='/assets/Images/Exclamation.gif' title='Institute is required!' />"
                                                ...
                                                <td align="left" valign="middle">
                                                    ...
                                                    <div class="ui-widget">
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" Display="Dynamic" runat="server"
                                                            ControlToValidate="txtDiploma" ErrorMessage="Please Select Diploma" Font-Bold="True"
                                                            ForeColor="Red" Text="<img src='/assets/Images/Exclamation.gif' title='Diploma is required!' />"
                                                            InitialValue="" ValidationGroup="Check"></asp:RequiredFieldValidator>
                                                        <asp:TextBox ID="txtDiploma" runat="server" CssClass="full" onkeydown="javascript:return (event.keyCode!=13);"
                                                ...
                                                <td align="left" valign="middle">
                                                    ...
                                                    <div class="ui-widget">
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" Display="Dynamic"
                                                            ...
                                                            InitialValue="" ValidationGroup="Check"></asp:RequiredFieldValidator>
                                                        <asp:TextBox ID="txtField" runat="server" CssClass="full" onkeydown="javascript:return (event.keyCode!=13);"
                                                    ...
                                                    <table id="tbl" runat="server" cellpadding="0" cellspacing="0" width="100%" class="nopadtbl"
                                                        ...
                                                        <tr>
                                                            <td>
                                                                ...
                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" Display="Dynamic" ControlToValidate="ddlFromMonth"
                                                            ...
                                                            <td>
                                                                <asp:DropDownList ID="ddlFromMonth" runat="server" Width="70px">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                ...
                                                                --%><asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" Display="Dynamic"
                                                                    ControlToValidate="txtGrade" ErrorMessage="Please Specify Score" Font-Bold="True"
                                                                    ForeColor="Red" Text="<img src='/assets/Images/Exclamation.gif' title='Score is required!' />"
                                                                    InitialValue="" ValidationGroup="Check"></asp:RequiredFieldValidator>
                                                ...
                                                <td align="left" valign="middle">
                                                    <table cellpadding="0" cellspacing="0" width="100%">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtPosition" runat="server" MaxLength="2" CssClass="medium" onkeydown="javascript:return (event.keyCode!=13);"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
