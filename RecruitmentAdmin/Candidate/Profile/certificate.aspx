<%@ Page Title="" Language="C#" MasterPageFile="~/Candidate/Profile/ProfileMaster.master" AutoEventWireup="true" CodeFile="certificate.aspx.cs" Inherits="Candidate_Profile_certificate" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContainer" runat="Server">
    <script type="text/javascript">
        ...
        function ResetCertificate() {
            if ((event.keyCode != 13))
                $('#ctl00_ContentContainer_hfCertificate').val("0");
        }
        function ResetField() {
            if ((event.keyCode != 13))
        ...
        function ShowHideCertificate(value) {
            //alert('shdgasdgahsgdashg');
            if (value == 1) {
                $('#ctl00_ContentContainer_profeCer').removeClass('hidden');
                $('#ctl00_ContentContainer_footerCer').removeClass('hidden');
            }
            else {
                $('#ctl00_ContentContainer_profeCer').addClass('hidden');
                $('#ctl00_ContentContainer_footerCer').addClass('hidden');
            }
        }
    </script>
    <style type="text/css">
    ...
    <script type="text/javascript">
        function ShowHideDateTo() {
            if (document.getElementById('chkEducationStatus').checked) {
                ...
                $('#ctl00_ContentContainer_PaperCount').removeClass('hidden');
            }
            else {
                $('#ctl00_ContentContainer_PaperCount').addClass('hidden');
        ...
        function hascertificate() {
            if ($("#ctl00_ContentContainer_profeCerList").is(':visible'))
                return true;
            else {
                if ($("#ctl00_ContentContainer_profeCer").is(':visible')) {
        ...
        function validateForm() {
            ...
            if ($('#ctl00_ContentContainer_PaperCount').is(':visible')) {
                if ($('.totalpapers').val() == "")
        ...
        <div class="tab-pane" id="Xstep2">
            <div class="xboxRight">
                ...
                <div class="suggestmore timeline" id="profeCerList" title="Drag to See more" runat="server">
                    ...
                    OnItemCommand="lvCertificate_OnItemCommand"
                        OnItemEditing="lvCertificate_ItemEditing" 
                        OnItemDeleting="lvCertificate_OnItemDeleting"
                                ...
                                <div id="xRemoveDetails<%#Eval("CandidateQualificationCode") %>" class="modal hide theModals"
                                    ...
                                    <div class="modal-footer">
                                        <div class="row-fluid">
                                            ...
                                            <div class="span6">
                                                <asp:LinkButton ID="LinkButton1" runat="server" class="xBook-button-normal" Style="text-align: center"
                                ...
                                <div class="xBoxInner">
                                    ...
                                    <div class="row-fluid">
                                        ...
                                        <div class="span8">
                                            <script type="text/javascript">
                                                $(function () {
                                                    $("#ctl00_ContentContainer_txtCertificate").autocomplete({
                                                        source: function (request, response) {
                                                            $.ajax({
                                                        ...
                                                        minLength: 2,
                                                        select: function (event, ui) {
                                                            $('#ctl00_ContentContainer_hfCertificate').val(ui.item.itemid);
                                                        },
                                                        change: function (event, ui) {
                                                            if (ui.item == null) {
                                                                $('#ctl00_ContentContainer_hfCertificate').val("0");
                ...
                <div class="xBoxInner">
                    <div class="xboxFooter" id="footerCer" runat="server">
                        <div class="row-fluid">
                            <div class="span8">
        ...
        <div class="xBoxInner">
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <a href="../profile/diploma.aspx" class="xBook-button-back fa13 pull-right" style="text-decoration: none;
