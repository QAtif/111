<%@ Page Title="" Language="C#" MasterPageFile="~/Candidate/Profile/ProfileMaster.master" AutoEventWireup="true" CodeFile="education.aspx.cs" Inherits="Candidate_Profile_education" %>
    ...
    <div id="xEduForm">
        <div class="tab-pane" id="Xstep2">
            <div class="xboxRight">
                ...
                <div class="suggestmore timeline" id="profeCerList" title="Drag to See more" runat="server">
                    <div class="LoadingImage">
                        <img src="/Area/assets/img/ajax-loader.gif" alt="">
                    </div>
                    <asp:ListView ID="lvEducation" runat="server"
                     OnItemCommand="lvEducation_OnItemCommand"
                        OnItemEditing="lvEducation_ItemEditing"
                         OnItemDeleting="lvEducation_ItemDeleting"
                        ...
                        <ItemTemplate>
                            ...
                            <li runat="server" id="li1" style="margin-left: 10px; float: left; list-style: none;" class="jcarousel-item jcarousel-item-horizontal jcarousel-item-1 jcarousel-item-1-horizontal"
                                jcarouselindex="1">
                                <div class="fadeit">
                                </div>
                                ...
                                <a href="#xRemoveDetails<%#Eval("CandidateQualificationCode") %>" title="" data-toggle="modal"
                                    class="closeicon"></a>
                                <img src='<%#Eval("LogoPath") %>' height="50px" width="50px" alt="" />
                                ...
                                <div id="xRemoveDetails<%#Eval("CandidateQualificationCode") %>" class="modal hide theModals"
                                    ...
                                    <div class="modal-footer">
                                        <div class="row-fluid">
                                            ...
                                            <div class="span6">
                                                <asp:LinkButton class="xBook-button-normal" Style="text-align: center" ID="lnkDelete"
                                                    runat="server" CommandArgument='<%#Eval("CandidateQualificationCode") %>' CommandName="Delete"
                        ...
                        <div class="span12">
                            ...
                            <div class="xBoxInner">
                                ...
                                <div class="row-fluid">
                                    <div class="span4">
                                        Level of Education
                                        <span class="xCustomTip" data-placement="top" data-toggle="tooltip" 
                                        data-original-title="The education level you are going to add like Matric, Intermediate, Bachelors or Masters.">(?)</span>
                                ...
                                <div class="row-fluid">
                                    <div class="span4">
                                        Field of Study                                        
                                        <span id="spnfos" class="xCustomTip" data-placement="top" data-toggle="tooltip" 
                                        data-original-title="The specific field in which you have completed your education level. For example, Bachelors in Computer Science, Bachelors in Commerce or Masters in Business Administration etc.">(?)</span>
                                ...
                                <div class="row-fluid">
                                    <div class="span4">
                                        Majors
                                        <span id="spnmajors" class="xCustomTip" data-placement="top" data-toggle="tooltip" 
                                        data-original-title="The major courses you studied in this education level. For example, Marketing, Finance, Networking, Project Management etc.">(?)</span>
                                ...
                                <div class="row-fluid">
                                    ...
                                    <div class="span8" id="skillsetArea">
                                ...
                                <div class="row-fluid" clientidmode="Static" id="dvAlevel" runat="server">
                                    <div class="span4">
                                        Marks Scored
                                        <span id="spnmarks" class="xCustomTip" data-placement="top" data-toggle="tooltip" 
                                        data-original-title="The marks you scored in form of Percentage or GPA. Please mention the Grade as well.">(?)</span>
                                        </div>
                                    <div class="span2">
                                        Percentage
                                    </div>
                                ...
                                <div class="row-fluid" clientidmode="Static" id="dvAlevel1" runat="server">
                                     <div class="span2 offset4 blabla">
                                         <asp:TextBox ID="txtPercentage" MaxLength="5" runat="server" onkeydown="return isNumberKey(event);"
                                            CssClass="jqtranformdone percentage" style="text-align:right; padding: 4px 20% !important; width:60% !important;" ClientIDMode="Static"
                                            ></asp:TextBox>
                                    </div>
                                    <div class="span2" id="dvGrade1" onkeydown="return isNumberKey(event);" runat="server"
                                        clientidmode="Static" style="display: none">
                                        <asp:TextBox ID="txtGPA" runat="server" MaxLength="4" CssClass="jqtranformdone gpa" ClientIDMode="Static"></asp:TextBox>
                                    </div>
                                    <div class="span2">
                                        <asp:TextBox ID="txtGrade" runat="server" MaxLength="4" CssClass="jqtranformdone" ClientIDMode="Static"></asp:TextBox>
                                    </div>
                                    <div class="span2">
                                    </div>
                                </div>
                                <div class="row-fluid" runat="server" id="dvGradeCount" clientidmode="Static" style="display: none">
                                    <div class="span4">
                                        Select Grades
                                        <span id="spngrades" class="xCustomTip" data-placement="top" data-toggle="tooltip" 
                                        data-original-title="The marks you scored in form of top Grades like 2 A's, 3 B's etc.">(?)</span>
                                        </div>
                                    <div class="span2">
                                        A
                                    </div>
                                ...
                                <div class="row-fluid">
                                    <div class="span4">
                                        Position
                                        <span class="xCustomTip" data-placement="top" data-toggle="tooltip" 
                                        data-original-title="If you have got any top position in this education level like 1st, 2nd or 3rd, select Yes.">(?)</span>
                                        </div>
                                    <div class="span4">
                ...
                <div class="xboxFooter">
                    <div class="row-fluid">
                        ...
                        <div class="span4">
                        <asp:Button CssClass="btn btn-small jqtranformdone" Text="Cancel"
                                runat="server" ID="btnCancel" Visible="false" ClientIDMode="Static" 
                            ...
                            <asp:Button CssClass="btn btn-small pull-right jqtranformdone" Text="Save & Add more"
                                ...
                                <input type="button" ClientIDMode="Static" style="display:none" id="btnVDate" runat="server" onclick="return validateForm();" />
                        </div>
                    </div>
                </div>
            </div>           
        ...
        function validateForm() {
            ...
            */
            ...
            if ($("#txtPercentage").is(':visible') && $("#txtGPA").is(':visible')) {
                if (($('.percentage').val() == "" || $('.percentage').val() == "%") && $('.gpa').val() == "") {
                    $('.gpa').addClass('error');
                    $('.percentage').addClass('error');
                }
                else {
                ...
                if ($('.percentage').val() == "%" || $('.percentage').val() == "") {
                    $('.percentage').addClass('error');
                    $('.gpa').addClass('error');
                } else {
                    $('.percentage').removeClass('error');
            ...
            else if ($("#txtGPA").is(':visible')) {
                //alert(2);
                if ($('.gpa').val() == "" && ($('.percentage').val() == "%" || $('.percentage').val() == "")) {
                    $('.gpa').addClass('error');
                    $('.percentage').addClass('error');
                } else {
                    $('.gpa').removeClass('error');
            ...
            //            if (isInstitute & isLevelofEducation & isdegree & ismajor & isfromMonth & isfromYear & istoMonth & istoYear & isBoard & isPercentage & isGPA & isPosition) {
            //                $(".errormsg").text("");
            //            }
            //            else {
            ...
            //            if (isInstitute & isLevelofEducation & isdegree & ismajor & isBoard & isPercentage & isGPA & isPosition) {
            //                $(".errormsg").text("");
