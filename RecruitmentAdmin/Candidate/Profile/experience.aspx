<%@ Page Title="" Language="C#" MasterPageFile="~/Candidate/Profile/ProfileMaster.master" AutoEventWireup="true" CodeFile="experience.aspx.cs" Inherits="Candidate_Profile_experience" %>
 ...
 <link href="http://ajax.googleapis.com/ajax/libs/jqueryui/1.8.1/themes/base/jquery-ui.css"
    ...
    <script type="text/javascript">
        ...
        function validateForm() {
            ...
            var isInitialSalary = false, isLocation = false, CorrectDate = true, InProgress = false;
            ...
            if ($('#txtNumber').val() == "" && $('#hfCompany').val() == "0")
            ...
            if (IsCompanyName & ISCompanyNumber & isJobTitle & isCurrentSalary & isInitialSalary & isLocation & isfromMonth & isfromYear & istoMonth & istoYear) {
                $(".errormsg").text("");
                return true;
            }
            else {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentContainer" runat="Server">
    <div class="xboxRight">
        ...
        <div class="suggestmore timeline" id="profeExpList" title="Drag to See more" runat="server">
            <div class="LoadingImage">
                <img src="/Area/assets/img/ajax-loader.gif" alt="" />
            </div>
            <asp:ListView ID="ListView1" runat="server" OnItemCommand="listView_itemCommand"
                OnItemEditing="ListView1_ItemEditing" OnItemDeleting="ListView1_ItemDeleting"  OnItemDataBound="listView_ItemDataBound">
                <LayoutTemplate>
                ...
                <ItemTemplate>
                    <li runat="server" id="li" style="margin-left: 10px; float: left; list-style: none;" class="jcarousel-item jcarousel-item-horizontal jcarousel-item-1 jcarousel-item-1-horizontal"
                        jcarouselindex="1">
                        <div class="fadeit">
                        </div>
                                ...
                                <div class="row-fluid">
                                    ...
                                    <div class="span6">
                                        <asp:LinkButton class="xBook-button-normal" Style="text-align: center" ID="lnkDelete"
                                            runat="server" CommandArgument='<%#Eval("CandidateExperience_Code") %>' CommandName="Delete"
                        ...
                        <div class="xBoxInner">
                            ...
                            <div class="row-fluid">
                                <div class="span4">
                                    Company Website</div>
                                <div class="span8">
                                    <asp:TextBox ID="txtWebsite" runat="server" CssClass="jqtranformdone" ValidationGroup="Check"
                                        MaxLength="100" ClientIDMode="Static"></asp:TextBox>
                                </div>
                            </div>
                            <div class="row-fluid">
                                <div class="span4">
                                    Company Email</div>
                                <div class="span8">
                                    <asp:TextBox ID="txtEmail" runat="server" CssClass="jqtranformdone" ValidationGroup="Check"
                                        MaxLength="100" ClientIDMode="Static"></asp:TextBox>
                                </div>
                            </div>
                            <div class="row-fluid">
                                ...
                                <div class="span8">
                                    <asp:TextBox ID="txtNumber" runat="server" CssClass="jqtranformdone" ValidationGroup="Check"
                                        MaxLength="100" ClientIDMode="Static" onkeypress="return isNumberKey(event);"></asp:TextBox>
                                </div>
                            </div>
                            <div class="row-fluid">
                                <div class="span4">
                    ...
                    <div class="span12">
                        ...
                        <div class="xBoxInner">
                            ...
                            <div class="row-fluid">
                                <div class="span8 pull-right">
                                    <asp:RadioButtonList ID="RadioButtonList1" runat="server" CssClass="radiobuttonlist"
                                        ...
                                        <asp:ListItem Value="1" Text="Permanent Position"></asp:ListItem>
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="span8">
                                    <asp:TextBox ID="txtResponsibilities" runat="server" TextMode="MultiLine" CssClass="jqtransformdone"
                                        MaxLength="1000" ClientIDMode="Static"></asp:TextBox>
                                </div>
                            </div>
                            <div class="row-fluid">
                                <div class="span4">
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="span4">
                                    <asp:TextBox ID="txtCurrentSalary" runat="server" Style="width: 94%;" ClientIDMode="Static"
                                        placeholder="Rs." CssClass="jqtranformdone" ValidationGroup="Check" onkeypress="return isNumberKey(event);"
                                        onkeyup="ValidatePlaceHolder(this)"></asp:TextBox>
                                </div>
                            </div>
                            <div class="row-fluid">
                                <div class="span4">
