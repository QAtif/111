<%@ Page Title="" Language="C#" MasterPageFile="~/Candidate/Profile/ProfileMaster.master" AutoEventWireup="true" CodeFile="familydetails.aspx.cs" Inherits="Candidate_Profile_familydetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentContainer" runat="Server">
            ...
            <asp:ListView ID="ListView1" runat="server" OnItemCommand="listView_itemCommand"
                ...
                <ItemTemplate>
                    <li style="margin-left: 10px; float: left; list-style: none;" class="jcarousel-item jcarousel-item-horizontal jcarousel-item-1 jcarousel-item-1-horizontal"
                        ...
                        <asp:LinkButton ID="lnkDelete" CssClass="closeicon" runat="server" CommandArgument='<%#Eval("CandidateFamilyMember_Code") %>'
    ...
    <script type="text/javascript">
        ...
        function validateForm() {
            ...
            if (IsRelation & IsName & IsQualification & IsOccupation & isMonth & isDay & isYear & IsMonthlyIncome & IsCompany & IsDesignation) {
                $(".errormsg").text("");
