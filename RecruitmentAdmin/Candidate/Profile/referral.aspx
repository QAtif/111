<%@ Page Title="" Language="C#" MasterPageFile="~/Candidate/Profile/ProfileMaster.master" AutoEventWireup="true" CodeFile="referral.aspx.cs" Inherits="Candidate_Profile_referral" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContainer" runat="Server">
    <script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.4.2/jquery.min.js"></script>
    <!--#include virtual="/Candidate/Profile/Area/includes/header-scripts-applications.html" -->
    <style type="text/css">
        .error
        {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentContainer" runat="Server">
    <div class="tab-pane" id="Xstep8">
        ...
        <div class="xboxRight">
            ...
            <div class="xBoxInner">
                <h6>
                    <strong>Please tell us, where did you hear about Axact</strong></h6>
                <div class="row-fluid">
                    <div class="span12">
                                    ...
                                    <div class="span12">
                                        <h4>
                                            <span>Enter Reference Details</span> <span class="xCustomTip" data-placement="top"
                                                data-toggle="tooltip" data-original-title="Full name and department of the person you know at Axact.">
                                                (?)</span></h4>
                                        <div class="xBoxInner">
                                            <div class="row-fluid">
                                                <div class="span4">
                                                    Axactian Name</div>
                                                <div class="span7">
                                                    <asp:TextBox ID="txtAxactianName" runat="server" CssClass="jqtranformdone"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="row-fluid">
                                                <div class="span4">
                                                    Department</div>
                                                <div class="span7">
                                                    <asp:TextBox ID="txtDepartment" runat="server" CssClass="jqtranformdone"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row-fluid">
                                                <div class="span4">
                                                    Reference Code <span class="xCustomTip" data-placement="top" data-toggle="tooltip"
                                                        data-original-title="The reference code of the person who has referred you at Axact.">
                                                        (?)</span></div>
                                                <div class="span7">
                                        ...
                                        <div class="xBoxInner">
                                            <div class="row-fluid">
                                                <div class="span4">
                                                    Other Medium</div>
                                                <div class="span7">
                                                    <asp:TextBox ID="txtOtherMedium" runat="server" CssClass="jqtranformdone"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="xBoxInner">
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <a href="../profile/personaldetails.aspx" class="xBook-button-back fa13 pull-right"
    ...
    <script type="text/javascript">
        ...
        function validateForm() {
            ...
            if ($('#<%=rblMedium.ClientID %> input:checked').val() == '') {
                ...
                if ($('#<%=txtAxactianName.ClientID%>').val() == "") {
                ...
                if ($('#<%=txtReferenceCode.ClientID%>').val() == "") {
                ...
                if ($('#<%=txtOtherMedium.ClientID%>').val() == "") {
