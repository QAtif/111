<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="AddAgentLead.aspx.cs" Inherits="Leads_AddAgentLead" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script>
        function bindCode() {
            ...
            document.getElementById('<%= txtphonecode.ClientID %>').value = document.getElementById('<%= ddlCountry.ClientID %>').value;  //  $('#ddlCountry :selected').val();
        }
        ...
        <table style="width: 98%" border="0" cellpadding="10" cellspacing="0">
            <tbody>
                <tr class="simple">
                    ...
                    <td>
                        <asp:TextBox ID="txtComapanyName" runat="server" Width="300px">
                        </asp:TextBox>
                        <ajax:AutoCompleteExtender runat="server" ID="acCompany" TargetControlID="txtComapanyName"
                        ...
                        <%--  <asp:RequiredFieldValidator ID="Req1" runat="server" Display="Dynamic" ControlToValidate="txtComapanyName"
                ...
                <tr class="simple">
                    ...
                    <td>
                        <asp:DropDownList ID="ddlIndustry" runat="server" Width="200px">
                            <asp:ListItem Value="" Selected="True" Text="Select your industry?"></asp:ListItem>
                ...
                <tr class="simple">
                    ...
                    <td>
                        <asp:DropDownList ID="ddlInterest" runat="server" Width="200px">
                            <asp:ListItem Value="" Text="Select your interests"></asp:ListItem>
                ...
                <tr class="simple">
                    ...
                    <td>
                        <asp:DropDownList ID="ddlDesignation" runat="server" Width="200px">
                            <asp:ListItem Value="" Text="Your designation?"></asp:ListItem>
                ...
                <tr class="simple">
                    ...
                    <td>
                        <asp:DropDownList ID="ddlCountry" runat="server" Width="200px" onchange="bindCode(this);">
                            ...
                            <asp:ListItem Value="92" Selected="True">PAKISTAN</asp:ListItem>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                <asp:DropDownList ID="ddlProductType" runat="server" Width="200px" AutoPostBack="True"
                                    ...
                                    <asp:ListItem Value="1" Selected="True"> Core Products </asp:ListItem>
