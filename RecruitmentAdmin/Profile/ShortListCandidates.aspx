<%@ Page Title="Shortlist Candidates" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="ShortListCandidates.aspx.cs" Inherits="Profile_ShortListCandidates" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="Server">
    <div class="headbar">
        <h2>
            <span>Shortlisted Candidates</span>
             <asp:ValidationSummary ID="vsValidators" HeaderText="Important Message(s) :"
    ...
    <div id="container" class="contentarea">
        <table width="60%" border="0" cellpadding="10" cellspacing="0">
            ...
            <tr>
                <td align="center" colspan="4">
                    <br />
                    <asp:LinkButton runat="server" ID="lnkSearch" CssClass="btn-ora nl" OnClick="lnkSearch_Click" ValidationGroup="Check">
                ...
                <ItemTemplate>
                    <tr id="trView" runat="server" class="simple">
                        <td style="text-align: center">
                            ...
                            <asp:HiddenField ID="hdnTestOrInterview" runat="server" Value='<%# Eval("Is_TestOrInterview")%>' />
                            <asp:HiddenField ID="hdnCPM_Code" runat="server" Value='<%# Eval("Candidate_ID")%>' />
                        </td>
                        <td style="text-align: center">
        ...
        <div id="DLock" runat="server" style="text-align: center; float: right; display: none;">
         <span runat="server" visible="false" id="divAction54" clientidmode="Static">
            <asp:LinkButton runat="server" ID="lnkLockCandidate" CssClass="btn-ora nl" OnClick="lnkLockCandidate_Click"
                OnClientClick="javascript:return Validate();">
                        <img src="/assets/images/icons/search.png" width="12" height="13" alt="" align="absmiddle" />&nbsp;Shortlist
            </asp:LinkButton>
            </span>
        </div>
    </div>
