<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ViewProfileCandidate__BK.aspx.cs" Inherits="Profile_ViewProfileCandidate__BK" %>
            ...
            <asp:Repeater ID="rptProfileLists" runat="server" OnItemDataBound="rptProfileLists_ItemDataBound">
                ...
                <ItemTemplate>
                    <tr id="trView" runat="server" class="simple">
                        ...
                        <td style="text-align: center">
                            <a id="aCandDetail" runat="server" class="openframeCand">
                                <%# Eval("Full_Name")%></a>
                        </td>
                        <td style="text-align: center">
                            <%# Eval("Email_Address")%>
