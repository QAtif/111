<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ResultPending.aspx.cs" Inherits="ResultPending"
            ...
            <div id="container" class="contentarea">
                <table width="60%" border="0" cellpadding="10" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtNIC" runat="server" Width="280px"></asp:TextBox><br />(e.g 9999999999999)
                        ...
                        <asp:Repeater ID="rptCandidateLists" runat="server" OnItemDataBound="rptCandidateLists_ItemDataBound">
                            ...
                            <ItemTemplate>
                                <tr class="simple">
                                    ...
                                    <td style="text-align: center">
                                        <a id="a1" runat="server"  target="_blank"> <%# Eval("Candidate_ID")%></a>
                                    </td>
                                    ...
                                    <td align="center">
                                        <a id="aCheckTest" runat="server" target="_blank">Check Test</a>
                                    </td>
                                </tr>
                            </ItemTemplate>
