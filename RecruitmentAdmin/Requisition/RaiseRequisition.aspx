<%@ Page Title="" Language="C#" MasterPageFile="~/popup.master" AutoEventWireup="true"
    CodeFile="RaiseRequisition.aspx.cs" Inherits="Requisition_RaiseRequisition" %>
        ...
        <div id="container" class="contentarea">
            ...
            <table width="70%" border="1" cellspacing="0" cellpadding="0" class="simple">
                ...
                <tr class="simple">
                    ...
                    <td>
                        ...
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" Display="Dynamic"
                            ...
                            Text="*" ErrorMessage="Enter only numbers of Canidates Required" ValidationExpression="^\d+$"></asp:RegularExpressionValidator>
                    </td>
                </tr>
                <tr class="simple">
                    <td>
                    ...
                    <td>
                        ...
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" Display="Dynamic"
                            ...
                            Text="*" InitialValue="" ErrorMessage="Enter only number for shortlisting candidates"
                ...
                <%--   <tr style="display:none">
                    ...
                    <td>
                        <asp:TextBox ID="txtPriority" runat="server" Width="50px" MaxLength="3"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtPriority"
                            InitialValue="" Text="*" ValidationGroup="valida" ErrorMessage="Enter priority of requisition"></asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" InitialValue=""
                            ControlToValidate="txtPriority" Text="*" ValidationGroup="valida" ErrorMessage="Enter only number for priority"
                            ValidationExpression="^\d+$"></asp:RegularExpressionValidator>
                    </td>
                </tr>--%>
                <tr class="simple">
