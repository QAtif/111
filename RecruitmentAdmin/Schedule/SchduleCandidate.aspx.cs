...
public partial class SchduleCandidate : CustomBasePage
{
    #region Variables
    ...
    protected void rptSlot_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        try
        {
            if (!string.IsNullOrEmpty(CandidateID))
            {
                ...
                SchduleCandidate.CandidateSlots = e.CommandArgument.ToString();
                ...
                if (SchduleCandidate.statusCode == (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.ShortlistedSchedulingPendingTest) || SchduleCandidate.statusCode == (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.TestFailedReSchedulingPendingTest) || SchduleCandidate.statusCode == (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.TestnotAppearedReSchedulingPending))
                {
                    ...
                    sqlCommand.Parameters.AddWithValue("@CandidateSlotId", SchduleCandidate.CandidateSlots);
                    sqlCommand.Parameters.AddWithValue("@StartTime", lblStartTime.Text);
                    sqlCommand.Parameters.AddWithValue("@Endtime", lblEndTime.Text);
                    sqlCommand.Parameters.AddWithValue("@StatusCode", SchduleCandidate.statusCode);
                    ...
                    sqlCommand.Parameters.AddWithValue("@RequisitionCode", Convert.ToInt32(SchduleCandidate.Requisition_Code));
                ...
                {
                    if (SchduleCandidate.statusCode != (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.TestPassedSchedulingPendingInterview) && SchduleCandidate.statusCode != (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.InterviewPassedOfferGenerationPending) && (SchduleCandidate.statusCode != (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.OfferGeneratedSchedulingPending) && SchduleCandidate.statusCode != (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.InterviewnotAppearedReSchedulingPending)) && (SchduleCandidate.statusCode != (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.InterviewFailedReSchedulingPending) && SchduleCandidate.statusCode != (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.NoTestSchedulingPendingInterview) && (SchduleCandidate.statusCode != (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.VerificationDoneAppointmentSchedulingPending) && SchduleCandidate.statusCode != (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.OfferNotAcceptedReSchedulingPendingOffer))) && (SchduleCandidate.statusCode != (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.OfferAcceptedVerificationSchedulingPending) && SchduleCandidate.statusCode != (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.OfferAcceptedJoiningNotDone)))
                        return;
                    GetEmployee(lblSlotDate.Text, strArray1[0], strArray2[0]);
                    SchduleCandidate.SlotsID = e.CommandArgument.ToString();
    ...
    protected void ddlVenue_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            if (SchduleCandidate.statusCode == (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.ShortlistedSchedulingPendingTest) || SchduleCandidate.statusCode == (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.TestnotAppearedReSchedulingPending) || SchduleCandidate.statusCode == (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.TestFailedReSchedulingPendingTest))
            {
                lblProfileHour.Text = dataTable.Rows[0]["Test_Duration"].ToString();
            }
            else
            {
                if (SchduleCandidate.statusCode != (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.NoTestSchedulingPendingInterview) && SchduleCandidate.statusCode != (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.NoTestSchedulingPendingInterview) && (SchduleCandidate.statusCode != (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.InterviewnotAppearedReSchedulingPending) && SchduleCandidate.statusCode != (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.TestPassedSchedulingPendingInterview)) && (SchduleCandidate.statusCode != (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.InterviewPassedOfferGenerationPending) && SchduleCandidate.statusCode != (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.OfferNotAcceptedReSchedulingPendingOffer) && (SchduleCandidate.statusCode != (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.OfferAcceptedJoiningNotDone) && SchduleCandidate.statusCode != (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.OfferAcceptedVerificationSchedulingPending))) && SchduleCandidate.statusCode != (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.VerificationDoneAppointmentSchedulingPending))
                    return;
    ...
    protected void lnkReserveInt_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (SchduleCandidate.statusCode == (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.TestPassedSchedulingPendingInterview) || SchduleCandidate.statusCode == (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.InterviewnotAppearedReSchedulingPending) || (SchduleCandidate.statusCode == (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.InterviewFailedReSchedulingPending) || SchduleCandidate.statusCode == (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.NoTestSchedulingPendingInterview)))
            {
            ...
            else if (SchduleCandidate.statusCode == (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.OfferGeneratedSchedulingPending) || SchduleCandidate.statusCode == (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.OfferNotAcceptedReSchedulingPendingOffer) || SchduleCandidate.statusCode == (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.OfferAcceptedJoiningNotDone))
            {
            ...
            else if (SchduleCandidate.statusCode == (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.VerificationDoneAppointmentSchedulingPending))
            {
            ...
            {
                if (SchduleCandidate.statusCode != (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.OfferAcceptedVerificationSchedulingPending))
                    return;
    ...
    public DataTable BindVenueAndProfileDetail(int venueCode, int profileCode)
    {
        ...
        selectCommand.Parameters.AddWithValue("@RequiositionCode", SchduleCandidate.Requisition_Code);
    ...
    public void GetVenue()
    {
        ...
        if (SchduleCandidate.statusCode == (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.ShortlistedSchedulingPendingTest) || SchduleCandidate.statusCode == (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.TestnotAppearedReSchedulingPending) || SchduleCandidate.statusCode == (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.TestFailedReSchedulingPendingTest))
            num = 3;
        else if (SchduleCandidate.statusCode == (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.NoTestSchedulingPendingInterview) || SchduleCandidate.statusCode == (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.InterviewFailedReSchedulingPending) || (SchduleCandidate.statusCode == (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.InterviewnotAppearedReSchedulingPending) || SchduleCandidate.statusCode == (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.TestPassedSchedulingPendingInterview)) || (SchduleCandidate.statusCode == (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.OfferGeneratedSchedulingPending) || SchduleCandidate.statusCode == (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.OfferNotAcceptedReSchedulingPendingOffer) || (SchduleCandidate.statusCode == (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.OfferAcceptedJoiningNotDone) || SchduleCandidate.statusCode == (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.OfferAcceptedVerificationSchedulingPending))) || SchduleCandidate.statusCode == (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.VerificationDoneAppointmentSchedulingPending))
            num = 2;
        SqlCommand selectCommand = new SqlCommand("XRec_Select_VenueBySchduleMediumType ", connection);
        selectCommand.Parameters.AddWithValue("@statusCode", SchduleCandidate.statusCode);
            ...
            if (secQueryString["refno"] != null)
            {
                ...
                if (dataTable != null)
                {
                    if (dataTable.Rows.Count > 0)
                    {
                        ...
                        SchduleCandidate.statusCode = int.Parse(dataTable.Rows[0]["Status_Code"].ToString());
                        hdnStatusCode.Value = dataTable.Rows[0]["Status_Code"].ToString();
                        DepartmentCode = dataTable.Rows[0]["SubDomain_Code"].ToString();
                        SchduleCandidate.Requisition_Code = dataTable.Rows[0]["Requisition_Code"].ToString();
                        if (SchduleCandidate.statusCode == (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.ShortlistedSchedulingPendingTest))
                        {
                            lblReqType.Text = "Test";
                            lblProfileHour.Text = dataTable.Rows[0]["Test_Duration"].ToString();
                        }
                        else if (SchduleCandidate.statusCode == (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.TestnotAppearedReSchedulingPending) || SchduleCandidate.statusCode == (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.TestFailedReSchedulingPendingTest))
                        {
                            lblReqType.Text = "Re-Test";
                            lblProfileHour.Text = dataTable.Rows[0]["Test_Duration"].ToString();
                        }
                        else if (SchduleCandidate.statusCode == (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.TestPassedSchedulingPendingInterview) || SchduleCandidate.statusCode == (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.NoTestSchedulingPendingInterview))
                        {
                            lblReqType.Text = "Interview";
                            lblProfileHour.Text = dataTable.Rows[0]["interview_duration"].ToString();
                        }
                        else if (SchduleCandidate.statusCode == (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.InterviewnotAppearedReSchedulingPending) || SchduleCandidate.statusCode == (int)Convert.ToInt16(Constants.CandidateLifeCycleStatus.InterviewFailedReSchedulingPending))
                        {
