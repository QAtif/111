<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="AddEditDeleteCompany.aspx.cs" Inherits="UniversalData_AddEditDeleteCompany" %>
    ...
    <div id="container" class="contentarea">
        <table width="60%" border="0" cellpadding="10" cellspacing="0">
            ...
            <tr>
                ...
                <td align="center">
                    <asp:TextBox runat="server" ID="txtCompanyName" Width="312"></asp:TextBox>                    
                </td>
            </tr>
            <tr>
        ...
        <asp:UpdatePanel ID="updatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div align="right" style="width: 100%; float: left; padding: 10px 0px;">
                    ...
                    <asp:LinkButton ID="lnkAddNew" runat="server" OnClick="lbtnAddNew_Click" CssClass="addsimple">Add Company </asp:LinkButton>
                </div>
                <asp:Repeater ID="rptCompany" runat="server" OnItemDataBound="rptCompany_ItemDataBound"
                    OnItemCommand="rptCompany_ItemCommand">
                    <HeaderTemplate>
                        <table width="80%" border="0" cellpadding="10" cellspacing="0">
                            <thead>
                                <tr class="simple">
                    ...
                    <ItemTemplate>
                        <tr class="simple">
                            ...
                            <td style="text-align: center">
                                <asp:HiddenField ID="hdnCompanyCode" runat="server" Value='<%# Eval("Company_Code")%>' />
                                <asp:HiddenField ID="hdnCount" runat="server" Value='<%# Eval("count")%>' />
                                <asp:Label ID="lblCompanyName" runat="server" Text='<%# Eval("Company")%>'></asp:Label>
                                <asp:TextBox ID="txtCompanyName" runat="server" Visible="false" Width="250px" Text='<%# Eval("Company")%>'></asp:TextBox>
                                <asp:RequiredFieldValidator ID="Required1" runat="server" ErrorMessage="*" Display="Dynamic"
                                    Text="*" ToolTip="Enter Company Name" ValidationGroup="valida" ControlToValidate="txtCompanyName"></asp:RequiredFieldValidator>
                            </td>
                            <td style="text-align: center">
                                <asp:ImageButton ID="lnkEdit" runat="server" CommandName="Edit" CommandArgument='<%# Eval("Company_Code")%>'
                                ...
                                <asp:ImageButton ID="lnkDelete" OnClientClick="return ConfirmDelete();" runat="server"
                                    CommandName="Delete" CommandArgument='<%# Eval("Company_Code")%>' ImageUrl="/assetsprocurement/images/Delete.png" />
                                <asp:LinkButton ID="lnkSave" CommandArgument='<%# Eval("Company_Code")%>' runat="server"
                    ...
                    <AlternatingItemTemplate>
                        <tr class="grey">
                            ...
                            <td style="text-align: center">
                                ...
                                <asp:HiddenField ID="hdnCount" runat="server" Value='<%# Eval("count")%>' />
                                <asp:Label ID="lblCompanyName" runat="server" Text='<%# Eval("Company")%>'></asp:Label>
                                <asp:TextBox ID="txtCompanyName" runat="server" Width="250px" Visible="false" Text='<%# Eval("Company")%>'></asp:TextBox>
                                <asp:RequiredFieldValidator ID="Required1" runat="server" ErrorMessage="*" Display="Dynamic"
                                    Text="*" ToolTip="Enter Company Name" ValidationGroup="valida" ControlToValidate="txtCompanyName"></asp:RequiredFieldValidator>
                            </td>
                            <td style="text-align: center">
