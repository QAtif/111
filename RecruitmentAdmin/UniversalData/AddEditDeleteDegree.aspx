<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="AddEditDeleteDegree.aspx.cs" Inherits="UniversalData_AddEditDeleteDegree" %>
    ...
    <div id="container" class="contentarea">
        <table width="60%" border="0" cellpadding="10" cellspacing="0">
            ...
            <tr>
                ...
                <td align="center">
                    <asp:TextBox runat="server" ID="txtDegreeName" Width="312"></asp:TextBox>                  
                </td>
            </tr>
            <tr>
        ...
        <asp:UpdatePanel ID="updatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div align="right" style="width: 100%; float: left; padding: 10px 0px;">
                    ...
                    <asp:LinkButton ID="lnkAddNew" runat="server" OnClick="lbtnAddNew_Click" CssClass="addsimple">Add Degree </asp:LinkButton>
                </div>
                <asp:Repeater ID="rptDegree" runat="server" OnItemDataBound="rptDegree_ItemDataBound"
                    OnItemCommand="rptDegree_ItemCommand">
                    <HeaderTemplate>
                        <table width="80%" border="0" cellpadding="10" cellspacing="0">
                            <thead>
                                <tr class="simple">
                    ...
                    <ItemTemplate>
                        <tr class="simple">
                            ...
                            <td style="text-align: center">
                                <asp:HiddenField ID="hdnDegreeCode" runat="server" Value='<%# Eval("Degree_Code")%>' />
                                <asp:HiddenField ID="hdnCount" runat="server" Value='<%# Eval("count")%>' />
                                <asp:Label ID="lblDegreeName" runat="server" Text='<%# Eval("Degree")%>'></asp:Label>
                                <asp:TextBox ID="txtDegreeName" runat="server" Visible="false" Width="250px" Text='<%# Eval("Degree")%>'></asp:TextBox>
                                <asp:RequiredFieldValidator ID="Required1" runat="server" ErrorMessage="*" Display="Dynamic"
                                    Text="*" ToolTip="Enter Degree Name" ValidationGroup="valida" ControlToValidate="txtDegreeName"></asp:RequiredFieldValidator>
                            </td>
                            <td style="text-align: center">
                                <asp:Label ID="lblProgram" runat="server" Text='<%# Eval("Program_Name")%>'></asp:Label>
                                <asp:DropDownList ID="ddlProgram" runat="server" Width="250px">
                                </asp:DropDownList>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*"
                                    Display="Dynamic" Text="*" ToolTip="Select Program" ValidationGroup="valida"
                                    ControlToValidate="ddlProgram"></asp:RequiredFieldValidator>
                            </td>
                            <td style="text-align: center">
                                <asp:ImageButton ID="lnkEdit" runat="server" CommandName="Edit" CommandArgument='<%# Eval("Degree_Code")%>'
                                ...
                                <asp:ImageButton ID="lnkDelete" OnClientClick="return ConfirmDelete();" runat="server"
                                    CommandName="Delete" CommandArgument='<%# Eval("Degree_Code")%>' ImageUrl="/assetsprocurement/images/Delete.png" />
                                <asp:LinkButton ID="lnkSave" CommandArgument='<%# Eval("Degree_Code")%>' runat="server"
                ...
                <div style="text-align: center;">
                    <asp:Button ID="btnSave" runat="server" Width="80px" CssClass="btn-ora nl" Text="Save" OnClick="btnSave_Click" />
                </div>
                <%--         </tbody>
                </table>--%>
            </ContentTemplate>
