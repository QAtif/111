<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="AddEditDeleteIndustry.aspx.cs" Inherits="UniversalData_AddEditDeleteIndustry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="Server">
    ...
    <table width="60%" border="0" cellpadding="10" cellspacing="0">
            ...
            <tr>
                ...
                <td align="center">
                    <asp:TextBox runat="server" ID="txtIndustryName" Width="312"></asp:TextBox>                    
                </td>
            </tr>
            <tr>
        ...
        <asp:UpdatePanel ID="updatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div align="right" style="width: 100%; float: left; padding: 10px 0px;">
                    ...
                    <asp:LinkButton ID="lnkAddNew" runat="server" OnClick="lbtnAddNew_Click" CssClass="addsimple">Add Industry </asp:LinkButton>
                </div>
                <asp:Repeater ID="rptIndustry" runat="server" OnItemDataBound="rptIndustry_ItemDataBound"
                    OnItemCommand="rptIndustry_ItemCommand">
                    <HeaderTemplate>
                        <table width="80%" border="0" cellpadding="10" cellspacing="0">
                            <thead>
                                <tr class="simple">
                    ...
                    <ItemTemplate>
                        <tr class="simple">
                            ...
                            <td style="text-align: center">
                                <asp:HiddenField ID="hdnIndustryCode" runat="server" Value='<%# Eval("Industry_Code")%>' />
                                <asp:HiddenField ID="hdnCount" runat="server" Value='<%# Eval("count")%>' />
                                <asp:Label ID="lblIndustryName" runat="server" Text='<%# Eval("Industry")%>'></asp:Label>
                                <asp:TextBox ID="txtIndustryName" runat="server" Visible="false" Width="250px" Text='<%# Eval("Industry")%>'></asp:TextBox>
                                <asp:RequiredFieldValidator ID="Required1" runat="server" ErrorMessage="*" Display="Dynamic"
                                    Text="*" ToolTip="Enter Industry Name" ValidationGroup="valida" ControlToValidate="txtIndustryName"></asp:RequiredFieldValidator>
                            </td>
                            <td style="text-align: center">
                                <asp:ImageButton ID="lnkEdit" runat="server" CommandName="Edit" CommandArgument='<%# Eval("Industry_Code")%>'
                                ...
                                <asp:ImageButton ID="lnkDelete" OnClientClick="return ConfirmDelete();" runat="server"
                                    CommandName="Delete" CommandArgument='<%# Eval("Industry_Code")%>' ImageUrl="/assetsprocurement/images/Delete.png" />
                                <asp:LinkButton ID="lnkSave" CommandArgument='<%# Eval("Industry_Code")%>' runat="server"
                    ...
                    <AlternatingItemTemplate>
                        <tr class="grey">
                            ...
                            <td style="text-align: center">
                                ...
                                <asp:HiddenField ID="hdnCount" runat="server" Value='<%# Eval("count")%>' />
                                <asp:Label ID="lblIndustryName" runat="server" Text='<%# Eval("Industry")%>'></asp:Label>
                                <asp:TextBox ID="txtIndustryName" runat="server" Width="250px" Visible="false" Text='<%# Eval("Industry")%>'></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="Required1" runat="server" ErrorMessage="*" Display="Dynamic"
                                    Text="*" ToolTip="Enter Industry Name" ValidationGroup="valida" ControlToValidate="txtIndustryName"></asp:RequiredFieldValidator>
                            </td>
                            <td style="text-align: center">
