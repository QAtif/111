<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="AddEditDeleteInstitute.aspx.cs" Inherits="UniversalData_AddEditDeleteInstitute" %>
    ...
    <div id="container" class="contentarea">
        <table width="60%" border="0" cellpadding="10" cellspacing="0">
            ...
            <tr>
                ...
                <td align="center">
                    <asp:TextBox runat="server" ID="txtInstituteName" Width="312"></asp:TextBox>                   
                </td>
            </tr>
            <tr>
        ...
        <asp:UpdatePanel ID="updatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div align="right" style="width: 100%; float: left; padding: 10px 0px;">
                    ...
                    <asp:LinkButton ID="lnkAddNew" runat="server" OnClick="lbtnAddNew_Click" CssClass="addsimple">Add Institute </asp:LinkButton>
                </div>
                <asp:Repeater ID="rptInstitute" runat="server" OnItemDataBound="rptInstitute_ItemDataBound"
                    OnItemCommand="rptInstitute_ItemCommand">
                    <HeaderTemplate>
                        <table width="80%" border="0" cellpadding="10" cellspacing="0">
                            <thead>
                                <tr class="simple">
                    ...
                    <ItemTemplate>
                        <tr class="simple">
                            ...
                            <td style="text-align: center">
                                <asp:HiddenField ID="hdnInstituteCode" runat="server" Value='<%# Eval("Institute_Code")%>' />
                                <asp:HiddenField ID="hdnCount" runat="server" Value='<%# Eval("count")%>' />
                                <asp:Label ID="lblInstituteName" runat="server" Text='<%# Eval("Institute")%>'></asp:Label>
                                <asp:TextBox ID="txtInstituteName" runat="server" Visible="false" Width="250px" Text='<%# Eval("Institute")%>'></asp:TextBox>
                                <asp:RequiredFieldValidator ID="Required1" runat="server" ErrorMessage="*" Display="Dynamic"
                                    Text="*" ToolTip="Enter Institute Name" ValidationGroup="valida" ControlToValidate="txtInstituteName"></asp:RequiredFieldValidator>
                            </td>
                            <td style="text-align: center">
                                <asp:ImageButton ID="lnkEdit" runat="server" CommandName="Edit" CommandArgument='<%# Eval("Institute_Code")%>'
                                ...
                                <asp:ImageButton ID="lnkDelete" OnClientClick="return ConfirmDelete();" runat="server"
                                    CommandName="Delete" CommandArgument='<%# Eval("Institute_Code")%>' ImageUrl="/assetsprocurement/images/Delete.png" />
                                <asp:LinkButton ID="lnkSave" CommandArgument='<%# Eval("Institute_Code")%>' runat="server"
                    ...
                    <AlternatingItemTemplate>
                        <tr class="grey">
                            ...
                            <td style="text-align: center">
                                ...
                                <asp:HiddenField ID="hdnCount" runat="server" Value='<%# Eval("count")%>' />
                                <asp:Label ID="lblInstituteName" runat="server" Text='<%# Eval("Institute")%>'></asp:Label>
                                <asp:TextBox ID="txtInstituteName" runat="server" Width="250px" Visible="false" Text='<%# Eval("Institute")%>'></asp:TextBox>
                                <asp:RequiredFieldValidator ID="Required1" runat="server" ErrorMessage="*" Display="Dynamic"
                                    Text="*" ToolTip="Enter Institute Name" ValidationGroup="valida" ControlToValidate="txtInstituteName"></asp:RequiredFieldValidator>
                            </td>
                            <td style="text-align: center">
