...
public partial class UniversalData_ViewAllAlert : CustomBasePage
{
    #region Variables
    ...
    protected void rptStatus_ItemDataBound(object source, RepeaterItemEventArgs e)
    {
        ...
        try
        {
            ...
            control1.Attributes.Add("onclick", "javascript:return confirm('Are you sure you want to delete this Alert?')");
            HiddenField control2 = (HiddenField)e.Item.FindControl("hfAlertCode");
            ((HtmlControl)e.Item.FindControl("btnEdit")).Attributes.Add("href", "AddEditAlert.aspx?" + SecureQueryString.QueryStringVar + "=" + sQString.encrypt("alertid=" + control2.Value));
        }
        catch (Exception ex)
        {
            throw;
    ...
    protected void rptStatus_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        {
            connection.Open();
            SqlCommand selectCommand = new SqlCommand("XRec_Delete_Alert", connection);
            selectCommand.CommandType = CommandType.StoredProcedure;
            selectCommand.Parameters.AddWithValue("@Alert_Code", e.CommandArgument);
