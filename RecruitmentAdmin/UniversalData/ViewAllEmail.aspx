<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="ViewAllEmail.aspx.cs" Inherits="UniversalData_ViewAllEmail" %>
                            ...
                            <ItemTemplate>
                                <tr class="simple">
                                    ...
                                    <td style="text-align: left">
                                        <%# Eval("EmailFunction_Code")%>
                                        <asp:HiddenField ID="hfEmailFunctionCode" Value='<%# Eval("EmailFunction_Code") %>'
                                            runat="server" />
                                    </td>
                                    <td style="text-align: left">
                                        <%# Eval("EmailFunction_Name")%>
                                    </td>
                                    <td style="text-align: left">
                                    ...
                                    <td style="text-align: center">
                                        ...
                                        <asp:ImageButton CssClass="button" ID="btnDelete" ImageUrl="/assets/images/icons/cancel.png"
                                            AlternateText="Delete" CommandName="Delete" CommandArgument='<%#Eval("EmailFunction_Code") %>'
                                            runat="server" />
                                    </td>
                                </tr>
                            </ItemTemplate>
