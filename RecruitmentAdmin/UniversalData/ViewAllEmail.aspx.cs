...
public partial class UniversalData_ViewAllEmail : CustomBasePage
{
    #region Variables
    ...
    protected void rptStatus_ItemDataBound(object source, RepeaterItemEventArgs e)
    {
        ...
        try
        {
            ...
            control1.Attributes.Add("onclick", "javascript:return confirm('Are you sure you want to delete this Email?')");
            HiddenField control2 = (HiddenField)e.Item.FindControl("hfEmailFunctionCode");
            ((HtmlControl)e.Item.FindControl("btnEdit")).Attributes.Add("href", "AddEditEmail.aspx?" + SecureQueryString.QueryStringVar + "=" + sQString.encrypt("emailid=" + control2.Value));
        }
        catch (Exception ex)
        {
            throw;
    ...
    protected void rptStatus_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        {
            connection.Open();
            SqlCommand selectCommand = new SqlCommand("XRec_Delete_Email", connection);
            selectCommand.CommandType = CommandType.StoredProcedure;
            selectCommand.Parameters.AddWithValue("@EmailFunction_Code", e.CommandArgument);
