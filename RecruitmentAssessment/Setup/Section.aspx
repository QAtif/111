    ...
    <div id="container" class="contentarea">
        <div align="left">
            <div style="width: 50%; float: right;" align="right">
                &nbsp;<a href="AddEditSection.aspx" class="openframemini btn-ora" style="float: right;"><img
                                ...
                                <ItemTemplate>
                                    <tr class="simple">
                                        ...
                                        <td style="text-align: left">
                                            <%# Eval("SectionName")%>
                                            <asp:HiddenField ID="hfSectionCode" Value='<%# Eval("SectionCode") %>' runat="server" />
                                        </td>
                                        ...
                                        <td style="text-align: center">
                                            ...
                                            <asp:ImageButton CssClass="button" ID="btnDelete" ImageUrl="/assets/images/icons/cancel.png"
                                                AlternateText="Delete" CommandName="Delete" CommandArgument='<%#Eval("SectionCode") %>'
                                                runat="server" />
                                        </td>
                                    </tr>
                                </ItemTemplate>
