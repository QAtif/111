...
public partial class Section : XRecBase
{
    ...
    public void ShowData()
    {
        ...
        try
        {
            if (connection.State == ConnectionState.Closed)
                connection.Open();
            SqlCommand sqlCommand = new SqlCommand("XRec_Select_Section ", connection);
    ...
    protected void rptSection_ItemDataBound(object source, RepeaterItemEventArgs e)
    {
        if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
        {
            ...
            HiddenField hfSectionCode = (HiddenField)e.Item.FindControl("hfSectionCode");
            HtmlAnchor btnEdit = (HtmlAnchor)e.Item.FindControl("btnEdit");
            
            string RedirectingLink = "AddEditSection.aspx?" + "sid" + "=" + hfSectionCode.Value;
    ...
    protected void rptSection_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        if (e.CommandName == "Delete")
        {
            ...
            {
                connection.Open();
                SqlCommand sqlCommand = new SqlCommand("XRec_Delete_Section", connection);
                sqlCommand.CommandType = CommandType.StoredProcedure;
                sqlCommand.Parameters.AddWithValue("@SectionCode", e.CommandArgument);
