                                ...
                                <table cellspacing="0" cellpadding="6" width="100%" border="0">
                                    <tr>
                                        <td valign="middle" width="49%" rowspan="5">
                                            <div align="center">
                                                <h2>
                                                    <img alt="" height="224" src="/assets/images/axact-login-screen.gif" width="340"></h2>
                                            </div>
                                        </td>
                                        <td width="4%">
                                            &nbsp;
                                        ...
                                        <td width="47%">
                                            <font face="Verdana, Arial, Helvetica, sans-serif" color="#0C090A" size="5"><strong>
                                                <font size="4">Please Sign In to Continue</font></strong></font><font face="Verdana, Arial, Helvetica, sans-serif"
                                                    color="#FF0000" size="4">&nbsp;</font><font face="Verdana, Arial, Helvetica, sans-serif"
                                                        color="#FF0000">
                                                        <br>
                                                    </font>
                                            <br>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" Display="Dynamic"
                                                ...
                                                Font-Bold="True" Font-Size="8px" ForeColor="Red" Text="<img src='/assets/Images/Exclamation.gif' title='Mobile Number / Email Address is Required' />"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" Display="Dynamic" runat="server"
                                                ...
                                                InitialValue=""></asp:RequiredFieldValidator>
                                                <br />
                                                <strong><font face="Verdana, Arial, Helvetica, sans-serif" color="#A9A9A9" size="1">(You can also use your Reference # / Applicant ID as password) </font></strong>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
