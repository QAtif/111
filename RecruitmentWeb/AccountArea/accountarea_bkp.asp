    ...
    upclick2(
        {
            ...
            function (filename) {
                ...
                document.getElementById('profileArea_imgProfileImage').style.paddingTop = 64;
                document.getElementById('profileArea_imgProfileImage').style.paddingLeft = 64;
            ...
            function (response_data) {
				...
				if(currentFileExt == ".gif" || currentFileExt == ".GIF" || currentFileExt == ".JPEG" || currentFileExt == ".jpeg" || currentFileExt == ".jpg" || currentFileExt == ".JPG" || currentFileExt == ".png" || currentFileExt == ".PNG" || currentFileExt == ".bmp" || currentFileExt == ".BMP")
			     {
                    var imageURL = document.getElementById('profileArea_profileImagePath').value + '/ProfilePhoto/' +  imageNum + fileExt;
    ...
    upclick(
        {
            ...
            function (filename) {
                ...
                document.getElementById('profileArea_draggable').style.paddingTop = 148;
                document.getElementById('profileArea_draggable').style.paddingLeft = 480;
            ...
            function (response_data) {
				...
				if(currentFileExt == ".gif" || currentFileExt == ".GIF" || currentFileExt == ".JPEG" || currentFileExt == ".jpeg" || currentFileExt == ".jpg" || currentFileExt == ".JPG" || currentFileExt == ".png" || currentFileExt == ".PNG" || currentFileExt == ".bmp" || currentFileExt == ".BMP")
			     {
                    var imageURL = document.getElementById('profileArea_profileImagePath').value + '/CovertPhotos/' + imageNum + fileExt2;
                   ...
                   // document.getElementById('profileArea_draggable').height = 313;
                    ...
                    document.getElementById('profileArea_draggable').src = imageURL;
                    document.getElementById('profileArea_draggable').className = 'CoverImage';
					//window.location.reload();
				}
				 else
...
<script type="text/javascript">
    $(document).ready(function () {
        $('.file_upload').parent('div').css('z-index', '-1');
    });
</script>
...
<script type="text/javascript">
		...
		function IPersonalInfo() {
         ...
         function IContactInfo() {
             ...
             var EmailAddress = document.getElementById('profileArea_txtEmailAddress').value;
             ...
             var EmailmatchArray = EmailAddress.match(emailPat);

             if (EmailmatchArray == null) {
                 // validatestring += "Your email address seems incorrect. Please try again.";
		  ...
		  function BContactInfo() {
             ...
             var EmailAddress = document.getElementById('profileArea_txtCEmailAddress').value;
