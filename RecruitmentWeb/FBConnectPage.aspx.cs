...
public partial class FBConnectPage : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            {
                CheckFB();
                Response.Redirect("http://xwebsrvde:705/products/protect/thanks.asp", false);
    ...
    public void CheckFB()
    {
        try
        {
            ...
            ViewState["FbID"] = currentUser.id.ToString().Trim() == null ? "" : currentUser.id.ToString().Trim() ?? "";
            ViewState["FbFullName"] = currentUser.name.Trim() == null ? "" : currentUser.name.Trim() ?? "";
            ViewState["Fbemail"] = currentUser.email.Trim() == null ? "" : currentUser.email.Trim() ?? "";
            ...
            try
            {
                ...
                FBpost.Action = new FBAction { Name = "Axact Protect", Link = "http://www.axact.com/products/protect/" };
                ...
                FBpost.Url = "http://www.axact.com/products/protect/";
            ...
            Page.ClientScript.RegisterClientScriptBlock(this.GetType(), "Msg", "alert('THANKS');", true);
