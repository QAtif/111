...
public partial class area_Allarea : CustomBaseClass, IRequiresSessionState
{
        ...
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (connection.State != ConnectionState.Open)
                    connection.Open();
                SqlCommand selectCommand = new SqlCommand("Select_AllAreaText", connection);
                ...
                {
                    rptAreatext.DataSource = dataSet.Tables[0];
                    rptAreatext.DataBind();
                }
