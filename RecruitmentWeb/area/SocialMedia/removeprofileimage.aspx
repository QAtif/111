<%@ Page Language="C#" AutoEventWireup="true" CodeFile="removeprofileimage.aspx.cs"
    Inherits="StudentArea_removeprofileimage" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>Remove Profile Image</title>
...
<body>
    ...
    <div class="career-service fullwidth" style="height: 170px;">
        ...
        <div class="profile-remove-content" style="width: 96.5%;">
            <img runat="server" id="imgProfileImage" width="30" height="30" />
        ...
        <div class="profile-remove-control" style="width: 96.5%;">
            ...
            <asp:LinkButton ID="lnkRemoveProfile" runat="server" CssClass="btn-ok" OnClick="lnkRemoveProfile_Click"
                OnClientClick="parent.profile(); parent.closeBPopup();"><span>Okay</span></asp:LinkButton>
        </div>
    </div>
    </form>
</body>
