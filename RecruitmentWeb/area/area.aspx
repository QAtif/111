<%@ Page Title="My Area" Language="C#" MasterPageFile="~/AreaMaster.master" AutoEventWireup="true"
    CodeFile="area.aspx.cs" Inherits="area_area" %>
          ...
          <p>We need to verify your contact information. </p>
            <ul class="summary-list">
              <li>
                ...
                <div class="summary-value"><asp:Label runat="server" ID="lblPhoneNumber"> </asp:Label><span runat="server" id="spverified1"><img src="/Area/assets/img/icons/tik.png" style="float:right" class="img-pad4x" alt=""></span>  <span runat="server" id="spnotverified1" ></span></div>
              </li>
              <li>
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="addpadd">
                        ...
                        <p>
                            You will be required to sign an authorization form that will be authorizing Bol
                ...
                <div class="row-fluid uploaded" style="display:none">
                    ...
                    <p class="clearfix notNow">
                        <a href="javascript:;" data-dismiss="modal" aria-hidden="true" data-original-title=""
                            title="" onclick="javascript:parent.location.href = 'http://careers.bolnetwork.com/Area/Area.aspx';">
                            Not Now! Later</a>
                    </p>
                </div>
                <!-- End row-fluid -->
...
<div id="get_started_modal" class="modal hide theModals" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-header">

    <button type="button" class="close" data-dismiss="modal" aria-hidden="true" data-original-title="" title="" style="font-size: 11px !important;">X</button>
    <h3>Get Started</h3>
  </div>	
  <div class="modal-body nopad">
  <div class="row-fluid msgarea">
  	<div class="span12">
    	<p class="smileicon">It is always a pleasure to welcome talented individuals such as yourself to Bol. We have planned
your Day 1 in the organization as exciting for you as possible.</p>
    </div>
  ...
  <div class="row-fluid">
  	<div class="span6">
    	<ul class="listing1">
        	<li>Organizational Orientation</li>

<li>Departmental Orientation </li>

<li>Professional Picture for Employee<br />
Portal Updation</li>

<li>Departmental Lunch  at Bol's Five<br />
Star Cafetaria</li>
        </ul>
    </div>
    <div class="span6 bdl-single">
    	<ul class="listing2">
<li>Scrumptious Cake baked with Perfection in<br />
Bol's in-house bakery</li>

<li>Welcome Greeting Card</li>

<li>Bol Branded MUG </li>

<li>Other Joining Benefits</li>
        </ul>
    </div>
  </div>
