...
//debugger;
    ...
    if(hdnVal=="1") {
		...
		$('#verification_set').attr('data-step','7');
		...
		$('#verification_step').attr('onclick','introJs().goToStep(8).start();')
	}
	}
	else {
		helpstatus = 0;
...
// software end edits
	$(document).ready(function() {	
	  $('.editicon,.fadeit').click(function() {
	        $(".LoadingImage").fadeIn();
	  });
	  
	  //helpstatus

	  $('#xShowHelp').click(function() {
	    if(helpstatus==0) {
	        $('.notification').slideDown();
	        $(this).text('Hide Help');
	        helpstatus =1;
