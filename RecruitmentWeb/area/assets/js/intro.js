...
(function (root, factory) {
  ...
  function IntroJs(obj) {
    ...
    this._options = {
      nextLabel: '<img src="/Area/assets/img/nxt-btn-tour.png" >',
      prevLabel: '&larr; Back',
      skipLabel: '<img src="/Area/assets/img/close-tour.png" >',
      doneLabel: '<img src="/Area/assets/img/finish-tour.png" id="changeclass" >',
  ...
  function _nextStep() {
    ...
    if (typeof (this._currentStep) === 'undefined') {
      	this._currentStep = 0;
	   $('.crumbs li:nth-child(1)').addClass('selected');
	  	//itemindex =2;

    } else {
	  $('.crumbs li').removeClass('selected');
	  itemindexasd =itemindex+1
	 $('.crumbs li:nth-child('+itemindexasd+')').addClass('selected');
      
	  //alert(this._currentStep);
	  itemindex++;
	  this._currentStep=itemindex-1;
  ...
  function _showElement(targetElement) {
	...
	//overlayLayer
	 ...
	 //modification process div 
      if (this._options.showProcessSteps) {
        var helperNumberLayer = document.createElement('div');
        helperNumberLayer.className = 'introjs-ProcessSteps';
    ...
    if (this._currentStep == 0) {
      ...
      skipTooltipButton.innerHTML = this._options.skipLabel;
	   ...
	   //skipTooltipButton.className = 'introjs-button endthetour';
      //prevTooltipButton.className = 'introjs-button introjs-prevbutton';
      //nextTooltipButton.className = 'introjs-button introjs-nextbutton introjs-disabled';
	  //skipTooltipButton.innerHTML = this._options.doneLabel;
	 // nextTooltipButton.className = 'introjs-button endthetour';
	  //skipTooltipButton.className = 'introjs-button endthetour';
	  //this._currentStep = 'undefined';
	   //skipTooltipButton.className = 'introjs-button endthetour';
	   //skipTooltipButton.innerHTML = this._options.doneLabel;
   ...
   // nextTooltipButton.focus();
    ...
    if (!_elementInViewport(targetElement.element)) {
      ...
      // Scroll down
        ...
        window.scrollBy(0, bottom + 300); // 70px + 30px padding from edge to look nice
      }
    }
  }
