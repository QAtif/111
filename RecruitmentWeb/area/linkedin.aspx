<%@ Page Language="C#" AutoEventWireup="true" CodeFile="linkedin.aspx.cs" Inherits="area_LinkedIn" %>
...
<body>
    ...
    <table width="500px" border="0" cellspacing="0" cellpadding="0" style="border-collapse: collapse;
        ...
        <tr>
            <td colspan="2">
                <div style="display: block;" runat="server" id="divFirst">
                    <p>
