...
public partial class crackersignup : Page, IRequiresSessionState
{
    ...
    public DataSet UpdateCandidate()
    {
        ...
        using (SqlConnection connection = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ToString()))
        {
            ...
            using (SqlCommand selectCommand = new SqlCommand("XRec_UpdateCandidateSignup", connection))
            {
                ...
                selectCommand.Parameters.Add("@PhoneNumber", str);
                ...
                selectCommand.Parameters.Add("@Linkedin_XML", XML);
    ...
    public void SendSMS()
    {
        ...
        string empty3 = string.Empty;
        getString(crackersignup.getPageHTML("http://bsms.ufone.com/bsms_app4/sendapi.jsp?id=" + ConfigurationManager.AppSettings["SMSID"].ToString() + "&message=" + str1 + "&shortcode=" + ConfigurationManager.AppSettings["MsgShortCode"].ToString() + "&lang=English&mobilenum=" + str2 + "&password=" + ConfigurationManager.AppSettings["MsgPassword"].ToString()), "<body>", "</body>").Trim();
    }
