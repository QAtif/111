...
// Type: XRecCRMLibrary.XRecCRMAPI.AddCustomerQueryCompletedEventHandler
...
namespace XRecCRMLibrary.XRecCRMAPI
{
  ...
  public delegate void AddCustomerQueryCompletedEventHandler(object sender, AddCustomerQueryCompletedEventArgs e);
}
